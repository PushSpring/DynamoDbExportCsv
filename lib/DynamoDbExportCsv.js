...
function DynamoDBExportCSV({ awsAccessKeyId, awsSecretAccessKey, awsRegion, options = {} }) {
    // Events this emits
    var infoEvent = 'info';
    ...
    const dynamoOptions = _.property('dynamodb')(options) || { maxRetries: 20 };
    var dynamodb = new AWS.DynamoDB(dynamoOptions);

    var s3 = new AWS.S3(_.property('s3')(options) || {});
