...
function DynamoDBExportCSV(awsAccessKeyId, awsSecretAccessKey, awsRegion, offline=false) {
    // Events this emits
    var infoEvent = 'info';
    ...
    if (offline) serviceConfigOptions.endpoint = 'http://localhost:8000'; // compatible with serverless-offline
