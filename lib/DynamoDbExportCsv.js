...
function DynamoDBExportCSV(awsAccessKeyId, awsSecretAccessKey, awsRegion) {
    ...
    function writeTableToCsv(table, columns, totalSegments, segment, compressed, filesize, s3Bucket, s3Path, filterExpression, expressionAttributeValues, expressionAttributeNames, callback) {
    ...
    this.exportTable = function exportTable(table, columns, totalSegments, compressed, filesize, s3Bucket, s3Path, filterExpression, expressionAttributeValues, expressionAttributeNames, callback) {
        if (typeof(filterExpression) === 'function') {
            callback = filterExpression;
            filterExpression = undefined;
        }
    ...
    // Public export table function
    this.exportTableWorker = function exportTableWorker(table, columns, totalSegments, segment, compressed, filesize, s3Bucket, s3Path, filterExpression, expressionAttributeValues, expressionAttributeNames, callback) {
        if (typeof(filterExpression) === 'function') {
            callback = filterExpression;
            filterExpression = undefined;
        }
        ...
        async.series([
            ...
            // Scan the table
            function (done) {
                writeTableToCsv(table, columns, totalSegments, segment, compressed, filesize, s3Bucket, s3Path, filterExpression, expressionAttributeValues, expressionAttributeNames, done);
            }
        ], callback);
    };
